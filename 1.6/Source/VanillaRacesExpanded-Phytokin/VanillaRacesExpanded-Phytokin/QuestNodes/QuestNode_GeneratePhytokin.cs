...
{
    public class QuestNode_GeneratePhytokin : QuestNode
    {
        [NoTranslate]
        ...
        protected override void RunInt()
        {
            ...
            allowedXenotypes.Add(InternalDefOf.VRE_Poluxkin);
            if (ModsConfig.RoyaltyActive)
            { allowedXenotypes.Add(InternalDefOf.VRE_Animakin); }
            if (ModsConfig.IdeologyActive)
            { allowedXenotypes.Add(InternalDefOf.VRE_Gauranlenkin); }

...
namespace VanillaRacesExpandedPhytokin
{
    ...
    public static class GraphicsCache
    {
        ...
        public static readonly Texture2D PolluxBarTex = SolidColorMaterials.NewSolidColorTexture(new ColorInt(128, 108, 131).ToColor);
        public static readonly Texture2D PolluxBarTexHighlight = SolidColorMaterials.NewSolidColorTexture(new ColorInt(150, 127, 153).ToColor);
